...
PauloFireMaster Maio 18, 2012
Henry-Keys disse:
Notei que vc ignorou nossos conselhos, prezado Paulo, para ser bom em Programação você deve ser paciente, calmo, dedicado e estudioso, ter pressa não é algo bom em programação, sem ofensa amigo, você mal sabe usar uma string e já quer dar uma olhada na source do Linux??

Atendendo ao teu pedido, toma essa source, é de um Jogo da Velha
(Xis, Círculo)
